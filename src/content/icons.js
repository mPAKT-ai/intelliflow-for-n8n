// IntelliFlow for n8n — inline Lucide icons (MIT licensed, no external requests).
// https://lucide.dev — icon path data embedded so nothing is fetched at runtime.
...
(function () {
  ...
  function icon(name, size = 16) {
    ...
    return (
      ...
      `stroke-linejoin="round" class="if-ico">${d}</svg>`
    );
  }

  IF.Icons = { icon, paths: P };
})();
